...
BIN = ./bin/remine_train ./bin/remine_segment ./bin/genSepath ./bin/tuple_generation_train ./bin/server #./bin/remine
...
./bin/server: ./src/server.cpp ./src/utils/*.h ./src/frequent_pattern_mining/*.h ./src/data/*.h ./src/classification/*.h ./src/model_training/*.h ./src/genSepath.h
./bin:
	mkdir -p bin
